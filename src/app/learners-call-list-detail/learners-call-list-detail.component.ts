...
@Component({
  selector: 'app-learners-call-list-detail',
  templateUrl: './learners-call-list-detail.component.html',
  styleUrls: ['./learners-call-list-detail.component.scss']
})
export class LearnersCallListDetailComponent implements OnInit {
