...
@Component({
    selector: 'app-script-spent-hour-list',
    templateUrl: './script-spent-hour-list.component.html',
    styleUrls: ['./script-spent-hour-list.component.scss']
})
export class ScriptSpentHourListComponent implements OnInit {
  ...
  getList() {
      ...
      this._service.get('Learner/GetLearnerWiseScriptList/' +this.id+"/"+ this.limit).subscribe(res => {
