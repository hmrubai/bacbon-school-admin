...
@Component({
    selector: 'app-paid-course-subjects',
    templateUrl: './paid-course-subjects.component.html',
    styleUrls: ['./paid-course-subjects.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class PaidCourseSubjectsComponent implements OnInit {
    ...
    modalTitle = 'Add Paid Course Subject';
    entryForm: FormGroup;
    submitted = false;
    btnSaveText = 'Save';
