...
@Component({
    selector: 'app-video-contents-spent-hour-list',
    templateUrl: './video-contents-spent-hour-list.component.html',
    styleUrls: ['./video-contents-spent-hour-list.component.scss']
})
export class VideoContentsSpentHourListComponent implements OnInit {
    ...
    getList() {
        ...
        this._service.get('Learner/GetLearnerWiseVideoSpentList/' +this.id+"/"+ this.limit).subscribe(res => {
