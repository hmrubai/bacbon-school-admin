...
@Component({
    selector: 'app-call-history-report',
    templateUrl: './call-history-report.component.html',
    encapsulation: ViewEncapsulation.None
})

export class CallHistoryReportComponent implements OnInit {
    ...
    ngOnInit() {
        this.filterForm = this.formBuilder.group({
            date: [[null,null],[Validators.required]],
        });
