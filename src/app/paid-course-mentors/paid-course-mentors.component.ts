...
@Component({
    selector: 'app-paid-course-mentors',
    templateUrl: './paid-course-mentors.component.html',
    styleUrls: ['./paid-course-mentors.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class PaidCourseMentorsComponent implements OnInit {
    ...
    deleteMentor(item){
        ...
        .subscribe(
            result => {
                if (result) {
                    console.log(item)
                    this._service.post('lc/paid-course-remove-mentor', { id : item.id }).subscribe(
                        data => {
                            console.log(item)
                            this.blockUI.stop();
