...
@Component({
    selector: 'app-paid-course-purchases',
    templateUrl: './paid-course-purchases.component.html',
    styleUrls: ['./paid-course-purchases.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class PaidCoursePurchasesComponent implements OnInit {
    ...
    downloadPurchaseReport(){
        ...
        this._service.downloadFile('paid-course/purchase-report-download', params).subscribe(res => {
            this.blockUI.stop();

            const url = window.URL.createObjectURL(res);
            var link = document.createElement('a');
            link.href = url;
            link.download = "Paid Course - Purchase Report";
            link.click();
        },
        err => {
