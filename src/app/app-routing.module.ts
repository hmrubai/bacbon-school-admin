...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'paid-course-lc-activate/:paid_course_id',
        loadChildren: () => import('./paid-course-lc-activate/paid-course-lc-activate.module').then(module => module.PaidCourseLCActivateModule),
        canActivate: [AuthGuard]
      },
      {
      ...
      {
        path: 'paid-course-completed-class',
        loadChildren: () => import('./paid-course-completed-class/paid-course-completed-class.module').then(module => module.PaidCourseCompletedClassModule),
        canActivate: [AuthGuard]
      },
      {
