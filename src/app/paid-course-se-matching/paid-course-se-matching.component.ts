...
@Component({
    selector: 'app-paid-course-se-matching',
    templateUrl: './paid-course-se-matching.component.html',
    styleUrls: ['./paid-course-se-matching.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class PaidCourseSEMacthingComponent implements OnInit {
    ...
    getAllPaidCourseStudentList() {
        this.blockUI.start('Getting data. Please wait...');
        this._service.get('lc/paid-course-students/' + this.paid_course_id).subscribe(res => {
