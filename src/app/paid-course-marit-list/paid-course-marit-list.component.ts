...
@Component({
    selector: 'app-paid-course-marit-list',
    templateUrl: './paid-course-marit-list.component.html',
    styleUrls: ['./paid-course-marit-list.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class PaidCourseMaritListComponent implements OnInit {
