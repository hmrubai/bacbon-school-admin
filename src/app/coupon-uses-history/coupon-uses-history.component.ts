...
@Component({
    selector: 'app-coupon-uses-history',
    templateUrl: './coupon-uses-history.component.html',
    styleUrls: ['./coupon-uses-history.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class CouponUsesHistoryComponent implements OnInit {
    ...
    downloadCouponUsesReport(){
        this.blockUI.start('Generating report. Please wait...');
        this._service.downloadFile('paid-course/coupon-uses-report').subscribe(res => {
            this.blockUI.stop();

            const url = window.URL.createObjectURL(res);
            var link = document.createElement('a');
            link.href = url;
            link.download = "Paid Course - Coupon Uses Report";
            link.click();
        },
        err => {
