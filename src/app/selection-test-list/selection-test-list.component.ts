...
@Component({
    selector: 'app-selection-test-list',
    templateUrl: './selection-test-list.component.html',
    styleUrls: ['./selection-test-list.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class SelectionTestListComponent implements OnInit {
