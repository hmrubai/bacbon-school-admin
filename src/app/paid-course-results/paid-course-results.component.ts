...
@Component({
    selector: 'app-paid-course-results',
    templateUrl: './paid-course-results.component.html',
    styleUrls: ['./paid-course-results.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class PaidCourseResultsComponent implements OnInit {
    ...
    filterResultList(course_meterial){
        ...
        this.blockUI.start('Getting Result. Please wait...');
            ...
            this._service.get('paid-course/result-list/' + course_meterial.id).subscribe(res => {
